...
import com.chivorn.hum.smartsearchview.suggestions.SearchSuggestionsAdapter;
import com.chivorn.hum.smartsearchview.suggestions.model.SearchSuggestion;
import com.chivorn.hum.smartsearchview.util.Util;
import com.chivorn.hum.smartsearchview.util.adapter.GestureDetectorListenerAdapter;
import com.chivorn.hum.smartsearchview.util.adapter.OnItemTouchListenerAdapter;
import com.chivorn.hum.smartsearchview.util.adapter.TextWatcherAdapter;
...
public class SmartSearchView extends FrameLayout {
    ...
    private final static String TAG = SmartSearchView.class.getSimpleName();
     ...
     * following calls to {@link SmartSearchView#swapSuggestions(List)}
     */
    ...
    public interface OnSearchListener {
         ...
         * {@link SmartSearchView#setShowSearchKey(boolean)}} is set to true.
         *
    ...
    public SmartSearchView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs);
    }
    ...
    private void applyXmlAttributes(AttributeSet attrs) {
        ...
        TypedArray a = getContext().obtainStyledAttributes(attrs, R.styleable.SmartSearchView);

        try {

            int searchBarWidth = a.getDimensionPixelSize(
                    R.styleable.SmartSearchView_smsv_searchBarWidth,
            ...
            int searchBarLeftMargin = a.getDimensionPixelSize(
                    R.styleable.SmartSearchView_smsv_searchBarMarginLeft,
                    ATTRS_SEARCH_BAR_MARGIN_DEFAULT);
            int searchBarTopMargin = a.getDimensionPixelSize(
                    R.styleable.SmartSearchView_smsv_searchBarMarginTop,
                    ATTRS_SEARCH_BAR_MARGIN_DEFAULT);
            int searchBarRightMargin = a.getDimensionPixelSize(
                    R.styleable.SmartSearchView_smsv_searchBarMarginRight,
                    ATTRS_SEARCH_BAR_MARGIN_DEFAULT);
            ...
            setQueryTextSize(a.getDimensionPixelSize(R.styleable.SmartSearchView_smsv_searchInputTextSize,
                    ATTRS_QUERY_TEXT_SIZE_SP_DEFAULT));
            setSearchHint(a.getString(R.styleable.SmartSearchView_smsv_searchHint));
            setShowSearchKey(a.getBoolean(R.styleable.SmartSearchView_smsv_showSearchKey,
                    ATTRS_SEARCH_BAR_SHOW_SEARCH_KEY_DEFAULT));
            setCloseSearchOnKeyboardDismiss(a.getBoolean(R.styleable.SmartSearchView_smsv_close_search_on_keyboard_dismiss,
                    ATTRS_DISMISS_ON_KEYBOARD_DISMISS_DEFAULT));
            setDismissOnOutsideClick(a.getBoolean(R.styleable.SmartSearchView_smsv_dismissOnOutsideTouch,
                    ATTRS_DISMISS_ON_OUTSIDE_TOUCH_DEFAULT));
            setDismissFocusOnItemSelection(a.getBoolean(R.styleable.SmartSearchView_smsv_dismissFocusOnItemSelection,
                    ATTRS_DISMISS_FOCUS_ON_ITEM_SELECTION_DEFAULT));
            setSuggestionItemTextSize(a.getDimensionPixelSize(
                    R.styleable.SmartSearchView_smsv_searchSuggestionTextSize,
                    Util.spToPx(ATTRS_SUGGESTION_TEXT_SIZE_SP_DEFAULT)));
            //noinspection ResourceType
            mLeftActionMode = a.getInt(R.styleable.SmartSearchView_smsv_leftActionMode,
                    ATTRS_SEARCH_BAR_LEFT_ACTION_MODE_DEFAULT);
            if (a.hasValue(R.styleable.SmartSearchView_smsv_menu)) {
                mMenuId = a.getResourceId(R.styleable.SmartSearchView_smsv_menu, -1);
            }
            setDimBackground(a.getBoolean(R.styleable.SmartSearchView_smsv_dimBackground,
                    ATTRS_SHOW_DIM_BACKGROUND_DEFAULT));
            setShowMoveUpSuggestion(a.getBoolean(R.styleable.SmartSearchView_smsv_showMoveSuggestionUp,
                    ATTRS_SHOW_MOVE_UP_SUGGESTION_DEFAULT));
            this.mSuggestionSectionAnimDuration = a.getInt(R.styleable.SmartSearchView_smsv_suggestionsListAnimDuration,
                    ATTRS_SUGGESTION_ANIM_DURATION_DEFAULT);
            setBackgroundColor(a.getColor(R.styleable.SmartSearchView_smsv_backgroundColor
                    , Util.getColor(getContext(), R.color.background)));
            setLeftActionIconColor(a.getColor(R.styleable.SmartSearchView_smsv_leftActionColor
                    , Util.getColor(getContext(), R.color.left_action_icon)));
            setActionMenuOverflowColor(a.getColor(R.styleable.SmartSearchView_smsv_actionMenuOverflowColor
                    , Util.getColor(getContext(), R.color.overflow_icon_color)));
            setMenuItemIconColor(a.getColor(R.styleable.SmartSearchView_smsv_menuItemIconColor
                    , Util.getColor(getContext(), R.color.menu_icon_color)));
            setDividerColor(a.getColor(R.styleable.SmartSearchView_smsv_dividerColor
                    , Util.getColor(getContext(), R.color.divider)));
            setClearBtnColor(a.getColor(R.styleable.SmartSearchView_smsv_clearBtnColor
                    , Util.getColor(getContext(), R.color.clear_btn_color)));
            int viewTextColor = a.getColor(R.styleable.SmartSearchView_smsv_viewTextColor
                    , Util.getColor(getContext(), R.color.dark_gray));
            setViewTextColor(viewTextColor);
            setQueryTextColor(a.getColor(R.styleable.SmartSearchView_smsv_viewSearchInputTextColor
                    , viewTextColor));
            setSuggestionsTextColor(a.getColor(R.styleable.SmartSearchView_smsv_viewSuggestionItemTextColor
                    , viewTextColor));
            setHintTextColor(a.getColor(R.styleable.SmartSearchView_smsv_hintTextColor
                    , Util.getColor(getContext(), R.color.hint_color)));
            setSuggestionRightIconColor(a.getColor(R.styleable.SmartSearchView_smsv_suggestionRightIconColor
